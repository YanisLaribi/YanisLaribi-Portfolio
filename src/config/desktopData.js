...
export const desktopIcons = [
  {
    id: "about",
    title: "YanisLaribi",
    iconUrl: "/YanisLaribi-Portfolio/images/icons/user.svg",
    emoji: "🧑‍💻",
  },
  {
    id: "projects",
  ...
  },
  {
    id: "contacts",
    title: "Contacts",
    iconUrl: "/YanisLaribi-Portfolio/images/icons/ContactIcone.webp",
    emoji: "📇",
  },
  { id: "resume", title: "Download CV", iconUrl: "", emoji: "📄" },
  {
    id: "linkedin",
    title: "LinkedIn",
    iconUrl: "/YanisLaribi-Portfolio/images/icons/linkedin.svg",
    emoji: "🔗",
  },
  {
    id: "music",
    title: "Music",
    iconUrl: "/YanisLaribi-Portfolio/images/icons/music folder.png",
    emoji: "🎵",
  },
];
...
export const getIconById = (id) =>
  desktopIcons.find((i) => i.id === id) ||
  startMenuIcons.find((i) => i.id === id);
  ...
  projects.forEach((item) => {
    if (
      ...
      results.push({
        ...
        desc: item.desc,
        iconUrl:
          item.iconUrl || "/YanisLaribi-Portfolio/images/icons/dossierLogo.png",
        emoji: item.emoji || "📄",
        type: "project",
        originalItem: item,
      });
